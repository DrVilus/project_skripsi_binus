...
class GlobalVariables {
  static List<PartsSelectModel> partSelectModelList = [
    PartsSelectModel("Case", "assets/img/case.png", PartEnum.pcCase,
        Queries.caseQuery, Queries.caseQueryById),
    PartsSelectModel("Cooling", "assets/img/cooling.png", PartEnum.cooling,
        Queries.coolingQuery, Queries.coolingQueryById),
    PartsSelectModel(
        "Motherboard",
        "assets/img/motherboard.png",
        PartEnum.motherboard,
        Queries.motherboardQuery,
        Queries.motherboardQueryById),
    PartsSelectModel("GPU", "assets/img/gpu.png", PartEnum.gpu,
        Queries.gpuQuery, Queries.gpuQueryById),
    PartsSelectModel("CPU", "assets/img/processor.png", PartEnum.cpu,
        Queries.cpuQuery, Queries.cpuQueryById),
    PartsSelectModel("PSU", "assets/img/PSU.png", PartEnum.psu,
        Queries.psuQuery, Queries.psuQueryById),
    PartsSelectModel("RAM", "assets/img/ramicon.png", PartEnum.ram,
        Queries.ramQuery, Queries.ramQueryById),
    PartsSelectModel("Storage", "assets/img/ssd.png", PartEnum.storage,
        Queries.storageQuery, Queries.storageQueryById),
  ];
