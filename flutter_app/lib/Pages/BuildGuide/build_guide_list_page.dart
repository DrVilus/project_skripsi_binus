                ...
                child: CustomScrollView(
                  slivers: <Widget>[
                    SliverList(
                            ...
                            children: [
                              Expanded(
                                child: CorneredButton(
                                  onPressed: () {
                                    if(widget.buildGuideModelListWithTitle.guideList[index] is BuildGuideModelListWithTitle){
                                      Navigator.push(
                                        context,
                                        PageRouteBuilder(
                                          pageBuilder: (context, animation1, animation2) => BuildGuideListPage(buildGuideModelListWithTitle: widget.buildGuideModelListWithTitle.guideList[index],),
                                          transitionDuration: Duration.zero,
                                        ),
                                      );

                                    }else if(widget.buildGuideModelListWithTitle.guideList[index] is BuildGuideModel){
                                      Navigator.push(
                                        context,
                                        PageRouteBuilder(
                                          pageBuilder: (context, animation1, animation2) => BuildGuideDescriptionPage(buildGuideModel: widget.buildGuideModelListWithTitle.guideList[index]),
                                          transitionDuration: Duration.zero,
                                        ),
                                      );
                                    }
                                  ...
                                  child: Align(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(
                                        widget.buildGuideModelListWithTitle.guideList[index].guideTitle,
                      ...
                      childCount: widget.buildGuideModelListWithTitle.guideList.length,
                    ))
                  ]
                ),
              )
