...
class BuildGuideVariablePage {
  static BuildGuideModelListWithTitle buildGuideMainList =
      BuildGuideModelListWithTitle("Build Guide", buildGuideList);

  static List<dynamic> buildGuideList = [
    BuildGuideModel(
        "Merencanakan budget dan speks",
        '''
