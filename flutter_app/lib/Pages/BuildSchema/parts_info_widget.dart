              ...
              children: [
                ...
                Query(
                  options: QueryOptions(
                    document: gql(selectedPartModel.queryById),
                                ...
                                children: [
                                  Consumer<BuildSchemaStateModel>(
                                    builder: (context, value, child) => (widget
                                                ...
                                                PartEnum.ram &&
                                            value
                                                .checkPartChosenId(PartEnum.ram)
                                                .isNotEmpty)
                                        ? Flexible(
                                            child: Text(
                                            data[0]['name'] +
                                                " x" +
                                                value.currentSelectedRAMCount
                                                    .toString(),
                                            style: TextStyles.sourceSans3,
                                          ))
                                        : Flexible(
                                      ...
                                      children: [
                                        ElevatedButton(
                                            onPressed: () {
                                              ...
                                              _launchUrl(data[0][GlobalVariables
                                                      .getQueryPriceText(
                                                          widget.partEnum)][0]
                                                  ['shop_link']!);
                                            },
                                            child: Text("Visit Store Page",
