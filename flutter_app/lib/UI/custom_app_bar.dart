      ...
      children: [
        Positioned(
          ...
          child: CustomPaint(
            ...
            child: SizedBox(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(top: 16, left: 150, right: 40),
                  child: Wrap(
                        ...
                        Consumer<BuildSchemaStateModel>(
                          builder: (context, value, child) => TextField(
                              ...
                              onChanged: (text) {
                                ...
                                value.textEditingController.selection =
                                    TextSelection.fromPosition(TextPosition(
                                        offset: value.textEditingController.text
                                            .length));
                              },
              ...
              builder: (context, value, child) => AnimatedPositioned(
                ...
                child: CanvasTouchDetector(
                  ...
                  builder: (context) => CustomPaint(
                    size: Size(50, (50 * 9.279069767441861).toDouble()),
                    //You can Replace [WIDTH] with your desired width for Custom Paint and height will be calculated automatically
                    painter: CustomPainterSidebar(
                        context, () => value.changeSidebarToggle()),
                  ),
                ),
              ),
            )),
        ...
        Consumer<BuildSchemaStateModel>(
            builder: (context, value, child) => GestureDetector(
                  ...
                  child:
                      FadeBlackBackground(toggleVariable: value.sidebarToggle),
                )),
        Visibility(
                          ...
                          PageRouteBuilder(
                            pageBuilder: (context, animation1, animation2) =>
                              ...
                              buildGuideModelListWithTitle:
                                  BuildGuideVariablePage.buildGuideMainList,
                            ),
        ...
        Consumer<BuildSchemaStateModel>(builder: (context, schemaState, child) {
          return AnimatedPositioned(
              duration: const Duration(milliseconds: 700),
              curve: Curves.fastOutSlowIn,
              left: schemaState.sidebarToggle
                  ? 0
                  : -(MediaQuery.of(context).size.width * 0.95),
              child: (() {
                if (schemaState.sidebarState == 1) {
                  return ChoosePartsModelWidget(
                      toggleSideBar: () => schemaState.changeSidebarToggle(),
                      partEnum: schemaState.selectedPartEnum);
                } else if (schemaState.sidebarState == 2) {
                  return PartsInfoWidget(
                      id: schemaState.selectedPartModelId,
                      partEnum: schemaState.selectedPartEnum,
                      toggleMenu: () => schemaState.changeSidebarToggle());
                } else {
                  return ChoosePartsWidget(
                      toggleSideBar: () => schemaState.changeSidebarToggle());
                }
              }()));
        }),
...
class MenuButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: InkWell(
        borderRadius:
            inkwellBorderRadius ?? const BorderRadius.all(Radius.zero),
        onTap: () => onPressed(),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
...
class CustomPainterAppbar extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_0.cubicTo(
        size.width * 0.9245327,
        size.height * 0.9827586,
        size.width * 0.9332492,
        size.height * 0.9627776,
        size.width * 0.9396760,
        size.height * 0.9272103);
    path_0.lineTo(size.width * 0.9868474, size.height * 0.6661379);
    path_0.cubicTo(
        size.width * 0.9932741,
        size.height * 0.6305707,
        size.width * 0.9968847,
        size.height * 0.5823310,
        size.width * 0.9968847,
        size.height * 0.5320328);
    path_0.lineTo(size.width * 0.9968847, size.height * 0.1896552);
    path_0.cubicTo(size.width * 0.9968847, size.height * 0.08491155,
        size.width * 0.9815421, 0, size.width * 0.9626168, 0);
    path_0.lineTo(size.width * 0.03738318, 0);
    path_0.cubicTo(
        size.width * 0.01845754,
        0,
        size.width * 0.003115265,
        size.height * 0.08491155,
        size.width * 0.003115265,
        size.height * 0.1896552);
    path_0.lineTo(size.width * 0.003115265, size.height * 0.7931034);
    path_0.cubicTo(
        size.width * 0.003115265,
        size.height * 0.8978466,
        size.width * 0.01845754,
        size.height * 0.9827586,
        size.width * 0.03738318,
        size.height * 0.9827586);
    ...
    Paint paint0Stroke = Paint()
      ...
      ..strokeWidth = size.width * 0.006230530;
...
class CustomPainterSidebar extends CustomPainter {
  ...
  CustomPainterSidebar(
      this.context, this.toggleSideBar); // context from CanvasTouchDetector
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_0.cubicTo(
        size.width * 0.3438442,
        size.height * 0.04095714,
        size.width * 0.02325581,
        size.height * 0.05194211,
        size.width * 0.02325581,
        size.height * 0.07882657);
    path_0.lineTo(size.width * 0.02325581, size.height * 0.9233484);
    path_0.cubicTo(
        size.width * 0.02325581,
        size.height * 0.9500025,
        size.width * 0.3393512,
        size.height * 0.9611429,
        size.width * 0.4854674,
        size.height * 0.9396366);
    path_0.lineTo(size.width * 0.9273279, size.height * 0.8746040);
    path_0.cubicTo(
        size.width * 0.9594372,
        size.height * 0.8698772,
        size.width * 0.9767442,
        size.height * 0.8641729,
        size.width * 0.9767442,
        size.height * 0.8583158);
    path_0.lineTo(size.width * 0.9767442, size.height * 0.1461419);
    path_0.cubicTo(
        size.width * 0.9767442,
        size.height * 0.1404388,
        size.width * 0.9603326,
        size.height * 0.1348762,
        size.width * 0.9297721,
        size.height * 0.1302206);
    path_0.close();
